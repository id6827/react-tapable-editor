...
import {getNodeByOffsetKey, getSelectableNodeByOffsetKey,} from '../../utils/findNode';
import {extractBlockKeyFromOffsetKey} from '../../utils/keyHelper';
import './styles.css';
import createAddOn from './createAddOn';
import {bindEvents, bindEventsOnce} from '../../utils/event/bindEvents';
import {CurrentSidebar, GetEditor} from '../../types';

function SidebarPlugin(this: any) {
