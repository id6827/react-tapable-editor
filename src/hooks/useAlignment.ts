...
const useAlignment = ({nodeRef, props}: HooksProps) => {
	...
	const mouseEnterRemoverRef = useRef<any>();
	const alignmentBarEventRemoverRef = useRef<any>();
	const hideBarTimeoutHandler = useRef<ReturnType<typeof setTimeout> | undefined | null>();
